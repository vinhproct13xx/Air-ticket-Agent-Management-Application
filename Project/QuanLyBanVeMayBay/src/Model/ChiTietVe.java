...
public class ChiTietVe {
    ...
    public ChiTietVe(String MaVe, String MaCB, String TenHK, String CMND, String SDT,String Email, boolean LoaiHK, int Gia, boolean LoaiVe, String TenHMB, String DiemKhoiHanh, String DiemDen, String SanBayDi, String SanBayDen, Date NgayKhoiHanh,int ThoiGianBay, Time GioKhoiHanh) {
        this.MaVe = MaVe;
        this.MaCB = MaCB;
        this.TenHK = TenHK;
        this.CMND = CMND;
