...
public class TaoChuyenBay_1 {
    ...
    public TaoChuyenBay_1(String MaCB, String MaHMB, String TenHMB, String DiemKhoiHanh, String DiemDen, String SanBayDi, String SanBayDen, int SoGheVipTrong, int SoGheThuongTrong, Date NgayKhoiHanh, int ThoiGianBay, Time GioKhoiHanh, String GiaVe)
    {
        this.MaCB=MaCB;
        this.MaHMB=MaHMB;
        this.TenHMB=TenHMB;
