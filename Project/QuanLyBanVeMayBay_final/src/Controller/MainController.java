...
public class MainController implements Initializable {
    ...
    @FXML
    private void btnTaoChuyenBayClick(ActionEvent event) throws IOException{
        loadTaoChuyenBay(event);
    }
    ...
    public void loadTaoChuyenBay(ActionEvent event) throws IOException {
        AnchorPane pane = FXMLLoader.load(getClass().getResource("/View/TaoChuyenBay.fxml"));
        rootPane.getChildren().setAll(pane);
        GeneralFuntion.FitChildContent(pane);
    }
    ...
    public void layUsername(String username,Integer level){
        tfUsername.setText(username);
        if(level==1){
            btnDatChuyenBay.setDisable(false);
            btnLichSuChuyenBay.setDisable(false);
            btnTaoChuyenBay.setDisable(false);
            btnThongKe.setDisable(false);
        }else if(level==2){
            btnDatChuyenBay.setDisable(false);
            btnLichSuChuyenBay.setDisable(false);
            btnTaoChuyenBay.setDisable(true);
            btnThongKe.setDisable(true);
        }else if(level==3){
            btnDatChuyenBay.setDisable(true);
            btnLichSuChuyenBay.setDisable(true);
            btnTaoChuyenBay.setDisable(false);
            btnThongKe.setDisable(true);
        }
    }
